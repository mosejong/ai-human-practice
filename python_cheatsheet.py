...
# ========================================
# 25. 느린 노트북에서 ML 실습 빨리 하는 팁
# ========================================

"""
[느린 노트북용 ML 실습 팁]

1. 처음부터 전체 데이터로 돌리지 말기
- 샘플링해서 먼저 테스트
- 예:
    df_sample = df.sample(10000, random_state=42)

2. 한 번에 모델 여러 개 돌리지 말기
- 하나씩 실행 후 결과 기록
- n=100, n=200, depth=10 한 번에 다 돌리면 오래 걸림

3. n_estimators를 처음엔 작게 시작하기
- 예:
...
5. 성능 확인용이면 작은 데이터로 먼저 실험하기
- 방향 확인 후 마지막에만 전체 데이터 사용

6. 중요도 낮은 feature는 줄여보기
- 불필요한 feature를 줄이면 속도 개선 가능

7. 결과 해석이 더 중요함
- 학습 속도보다
  "왜 이런 결과가 나왔는지" 이해하는 게 더 중요

8. 인터넷보다 컴퓨터 성능 영향이 더 큼
- 모델 학습은 대부분 CPU가 수행
- 와이파이는 데이터 다운로드 때만 영향 큼
